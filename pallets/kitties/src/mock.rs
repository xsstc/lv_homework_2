...
impl system::Config for Test {
	...
	type AccountData = pallet_balances::AccountData<Balance>; // () 修改为 pallet_balances::AccountData<Balance>
	type OnNewAccount = ();
...
impl pallet_randomness_collective_flip::Config for Test {} // for Runtime修改为 for Test

parameter_types! {
    pub const KittyStake: u128 = 10_000;
}

impl pallet_kitties::Config for Test {
	type Event = Event;

	type Randomness = Randomness;  // 引入Randomness类型
